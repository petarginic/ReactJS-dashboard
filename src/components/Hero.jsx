                ...
                <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2 bg-slate-50">             
                        <div>
                            ...
                            <div className="flex justify-center lg:justify-start mt-6">
                                <a className="px-4 py-3 bg-gray-900 text-gray-200 text-xs font-semibold rounded hover:bg-gray-800" >{props.button1}</a>
                                <a className="mx-4 px-4 py-3 bg-gray-300 text-gray-900 text-xs font-semibold rounded hover:bg-gray-400" >{props.button2}</a>
                            </div>
                        </div>
                </div>
